...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <form id="form" enctype="multipart/form-data" action="{{$data == null ? route('admin.masterdata.destination.store'):route('admin.masterdata.destination.update', $data->id)}}" method="post">
                    @csrf
                    @if ($data != null)
                    @method('PUT')
                    @endif
            ...
            <div class="card-footer text-end">
                <a href="{{route('admin.masterdata.destination.index')}}" class="btn btn-dark"><i class="fa fa-arrow-left mr-2"></i> Back</a>
